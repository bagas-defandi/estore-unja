        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <section class="bg-white dark:bg-gray-900 my-6 rounded-md">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-14">
                    ...
                    <form action="{{ route('penjual.products.update', ['product' => $product->id]) }}" method="POST"
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="w-full">
                                ...
                                <input type="number" name="harga" id="harga"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Rp. 50.000" value="{{ old('harga') ?? $product->harga }}">
                                @error('harga')
                                    <div class="text-left font-semibold text-sm text-red-600 mt-2">{{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="w-full">
                                ...
                                <input type="number" name="stok" id="stok"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="12" value="{{ old('stok') ?? $product->stok }}">
                                @error('stok')
                                    <div class="text-left font-semibold text-sm text-red-600 mt-2">{{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="deskripsi" rows="8"
                                    ...
                                    placeholder="Masukkan Deskripsi" name="deskripsi">{{ old('deskripsi') ?? $product->deskripsi }}</textarea>
                                @error('deskripsi')
                                    <div class="text-left font-semibold text-sm text-red-600 mt-2">{{ $message }}
                                    </div>
                                @enderror
